...
import { ArrowLeftRight, CheckCircle2, ArrowRight, Bot, Sparkles, Printer } from 'lucide-react';
...
export default function ComparisonPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in print-content" data-testid="comparison-page">
      <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-6">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button onClick={() => window.print()} data-testid="comparison-print-btn"
              className="no-print flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs border border-yellow-500/25 text-yellow-400 hover:bg-yellow-500/10 transition-all">
